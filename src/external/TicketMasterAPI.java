...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "qvwtudmjZBcLs8KnPEgUlZM4m0Tvm8KY";

	public List<Item> search(double lat, double lon, String keyword) {
// Encode keyword in url since it may contain special characters like chinese charactes
		if (keyword == null) {
...
// Make your url query part like: "apikey=12345&geoPoint=abcd&keyword=music&radius=50"
		...
		try {
			...
			// if (responseCode != 200) ...... handle error

			// Now read response body to get events data
			// InputStreamReader like a device to get the input stream, the bufferedReader
			// get line by line
	...
	/*
	 * { "name": "laioffer", "id": "12345", "url": "www.laioffer.com", ...
	 * "_embedded": { "venues": [ { "address": { "line1": "101 First St,", "line2":
	 * "Suite 101", "line3": "...", }, "city": { "name": "San Francisco" } ... },
	 * ... ] } ... }
	 */
